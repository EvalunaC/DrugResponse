...
Camptothecin_table <- read.csv("/extraspace/ychen42/Drug_Response/Own_update2.0/Evaluation/PCC_CV28_eachdrug/Camptothecin_PCC_CV28.csv", header = TRUE,na.strings="NA")
PCC_table <- read.csv("/extraspace/ychen42/Drug_Response/Own_update2.0/Evaluation/PCC_CV28_eachdrug/JQ1_PCC_CV28.csv", header = TRUE,na.strings="NA")

PCC_table <- rbind(Camptothecin_table[16:30,],PCC_table) #192 drugs

filename = paste("/extraspace/ychen42/Drug_Response/Own_update2.0/Evaluation/192drugs_PCC_CV28_boxplot07162021.pdf", sep="",collapse = NULL)
pdf(filename,width=10, height=10)
ggviolin(subset(PCC_table, !is.na(PCC_CV28)), x = "method", y = "PCC_CV28", title="192 Drugs CV28 PCC Violinplot",
          color = "method", ylim = c(0.1, 0.75),
...
ggboxplot(PCC_table, x = "method", y = "PCC_CV28",title="192 Drugs CV28 PCC Boxplot",
          color = "method", ylim = c(0.1, 0.75),font.label = list(size = 4),
